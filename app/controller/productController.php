    ...
    function update_status_cart()
    {
        ...
        if (isset($_POST['method_pay']) && $_POST['method_pay'] == 'vnpay') {
            ...
            try {
                ...
                // Recipients
                $mail->setFrom('nnqn15@gmail.com', 'Be yeu shop');
                $mail->addAddress($Email, $HoVaTen);
            
                // Content
                $mail->isHTML(true);
                // Cài đặt tiêu đề và nội dung của email
                $mail->Subject = "Xac nhan don hang #" . $MaHD;;
                $mail->Body = "<p>Cảm ơn bạn đã mua hàng. Đây là hóa đơn của bạn:</p>";
                $mail->Body .= '<div class="order-content">
