...
<div class="page-header page-header-bg text-left" style="background: 50%/cover #D4E1EA url('<?=BASE_URL?>public/upload/page-header-bg.jpg');">
	<div class="container">
		<h2>VỀ CỬA HÀNG</h2>
		<a href="<?=BASE_URL?>index.html?mod=contact" class="btn btn-dark">Liên hệ</a>
	</div>
</div>
...
<nav aria-label="breadcrumb" class="breadcrumb-nav">
	<div class="container">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="<?=BASE_URL?>index.html?mod=page"><i class="fa-solid fa-house"></i></a></li>
		...
		<div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
			...
			<div class="testimonial">
				<div class="testimonial-owner">
					<figure>
						<img src="<?=BASE_URL?>public/upload/avatar/avatar_TRINH.png" alt="client">
					</figure>
			...
			<div class="testimonial">
				<div class="testimonial-owner">
					<figure>
						<img src="<?=BASE_URL?>public/upload/avatar/avatar_NHI.jpg" alt="client">
					</figure>
			...
			<div class="testimonial">
				<div class="testimonial-owner">
					<figure>
						<img src="<?=BASE_URL?>public/upload/avatar/avatar_NAM.png" alt="client">
					</figure>
