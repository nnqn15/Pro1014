...
<div class="box">
<?php
if (isset($_SESSION['ThongBao']['Thanhcong'])) {
...
?>
    <table>
        ...
        <form action="<?=BASE_URL?>admin/donhangsua/<?=$show['MaHD']?>" method="post">
            ...
            <tbody>
                ...
                <td>
                    <div>
                        <a href="<?=BASE_URL?>hoadon/<?=$show['MaHD']?>" class="btn " >Xem chi tiết</a>
