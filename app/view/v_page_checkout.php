        ...
        <div class="col-lg-7">
            <ul class="checkout-steps">
                <li>
                    ...
                    <form  action="<?= BASE_URL ?>update_status_cart" method="post" id="checkout-form">
                        <div class="form-group">
                            <label>Họ và tên
                                <abbr class="required" title="required">*</abbr></label>
                            <input type="text" class="form-control" id="HoTen" name="HoVaTen" placeholder="Họ và tên"
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" required id="SoDienThoai" name="SoDienThoai" placeholder="Số điện thoại"
        ...
        <div class="col-lg-5">
            <div class="order-summary">
                ...
                <table class="table ">
                    ...
                    <?php if(isset($_SESSION['user'])) $_SESSION['MaHD'] = $MaHD; ?>
                    <tfoot>
                        <tr>
                            <td>Mã giảm giá</td>
                            <td>
                        ...
                        <input type="hidden" name="TongTien" value="<?=$total_cart?>">
