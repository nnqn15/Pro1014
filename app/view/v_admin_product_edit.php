...
.error{
    ...
    .boxtb{
        ...
        <div class="box_content">
            ...
            <div class="box">
                <form action="<?=BASE_URL?>admin/product/edit/<?=$show_AnhSP['MaSP']?>" id="form_editProduct" method="POST" enctype="multipart/form-data">
                    <div class="roww">
                    <div class="col-md-4">
                            <div class="mb-3">
                               ...
                               <div class="showanh">
                                    ...
                                    <div><img src="<?=BASE_URL?>public/upload/products/<?=$show_AnhSP['AnhSP']?>" width = "100" height = "100" alt=""></div>
                               </div>
                            </div>
                            <div class="mb-3">
                               ...
                               <div><input type="file"  name="anh1" class="form-control" id="AnhSP1" ></div>
                                    <div><img src="<?=BASE_URL?>public/upload/products/<?=$show_AnhSP['AnhSP1']?>" width = "100" height = "100" alt=""></div>
                               </div>
                            </div>
                            <div class="mb-3">
                               ...
                               <div class="showanh">
                                    ...
                                    <div><img src="<?=BASE_URL?>public/upload/products/<?=$show_AnhSP['AnhSP2']?>" width = "100" height = "100" alt=""></div>
                               </div>
                            </div>
                            <div class="mb-3">
                               ...
                               <div class="showanh">
                                    ...
                                    <div><img src="<?=BASE_URL?>public/upload/products/<?=$show_AnhSP['AnhSP3']?>" width = "100" height = "100" alt=""></div>
                               </div>
                            </div>
                            <div class="mb-3">
                               ...
                               <div><input type="file"  name="anh4" class="form-control" id="AnhSP4" ></div>
                                    <div><img src="<?=BASE_URL?>public/upload/products/<?=$show_AnhSP['AnhSP4']?>" width = "100" height = "100" alt=""></div>
                               </div>
                            </div>
                        </div>
                    <div  class="col-md-8">
                                ...
                                <div class="mb-3" style="padding-bottom: 15px;">
                                    ...
                                    <select id="MaDM" name="MaDM">
                                        <?php foreach( $danhmuc as $getdanhmuc ){
                                            echo '<option value="'.$getdanhmuc['MaDM'].'"';
                                            if($show_AnhSP['MaDM']==$getdanhmuc['MaDM']){
                                                echo 'selected ';
                                            }
                                            echo '>'.$getdanhmuc['TenDM'].'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
