...
$SLBinhLuan=$data['SLBinhLuan'];
$product_same=$data['product_same'];
$checkMuaSP=$data['checkMuaSP'];
$proshow=new productModel;
$wishshow=new wishlistModel;
?>
<style>
#quantity-product {
    margin: 0;
...
<div class="container">
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <ol class="breadcrumb">
            <li><a href="<?= BASE_URL ?>page"><i class="fa-solid fa-house"></i></a></li>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 product-single-gallery">
                    ...
                    <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                        <div class="product-item">
                            <img class="product-single-image"
                                src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP'] ?>"
                                data-zoom-image="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP'] ?>"
                                width="468" height="468" alt="product" />
                        </div>
                        <div class="product-item">
                            <img class="product-single-image"
                                src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP1'] ?>"
                                data-zoom-image="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP1'] ?>"
                                width="468" height="468" alt="product" />
                        </div>
                        <div class="product-item">
                            <img class="product-single-image"
                                src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP2'] ?>"
                                data-zoom-image="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP2'] ?>"
                                width="468" height="468" alt="product" />
                        </div>
                        <div class="product-item">
                            <img class="product-single-image"
                                src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP3'] ?>"
                                data-zoom-image="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP3'] ?>"
                                width="468" height="468" alt="product" />
                        </div>
                        <div class="product-item">
                            <img class="product-single-image"
                                src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP4'] ?>"
                                data-zoom-image="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP4'] ?>"
                                width="468" height="468" alt="product" />
                        </div>
                    </div>
                ...
                <div class="prod-thumbnail owl-dots">
                    <div class="owl-dot">
                        <img src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP1'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP2'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP3'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                    <div class="owl-dot">
                        <img src="<?= BASE_URL ?>public/upload/products/<?= $product_detail['AnhSP4'] ?>" width="110"
                            height="110" alt="product-thumbnail" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-6 product-single-details">
                ...
                <div class="ratings-container">
                    <div class="product-ratings">
                        <?php
                                $rating = $proshow->ratings_trungbinh($product_detail['MaSP']);
                ...
                <div class="price-box">
                    ...
                    <div class="product-action">
                        <form action="<?= BASE_URL ?>addtocart" method="post">
                            ...
                            <input name="TenSP" type="hidden" value="<?= $product_detail['TenSP'] ?>">
                            </br>
                        ...
                        <a href="<?= BASE_URL ?>cart" class="btn btn-gray view-cart d-none"
                    ...
                    <div class="product-single-share mb-2">
                        ...
                        <a href="<?= BASE_URL ?>page/wishlist" <?php if(isset($_SESSION['user'])){
                                        ...
                                        $CheckWish=$wishshow->check_wishByProductAndUser($MaTK,$product_detail['MaSP']);
                                        if($CheckWish!=""){
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                    <div class="product-size-content">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?= BASE_URL ?>public/upload/products/single/body-shape.png" alt="body shape"
                ...
                <div class="tab-pane fade" id="product-reviews-content" role="tabpanel"
                    ...
                    <div class="product-reviews-content">
                        ...
                        <div class="comment-list">
                            ...
                            <div class="comments mb-1">
                                <figure class="img-thumbnail">
                                    <img src="<?= BASE_URL ?>public/upload/avatar/<?= $value['HinhAnh'] ?>" alt="author"
                        ...
                        <div class="add-product-review">
                            ...
                            <form id="comment" action="<?= BASE_URL ?>product/comment" method="post"
                                ...
                                <input type="hidden" name="TenSP" value="<?= $product_detail['TenSP'] ?>">
                    ...
                    <div class="products-section pt-0">
                        <h2 class="section-title">
                            ...
                            <div class="container">
                                <div class="row">
                                    <?=$proshow->show_product($product_same)?>
                                </div>
                            </div>
                        <!-- End .products-slider -->
                    </div>
