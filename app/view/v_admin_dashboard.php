...
$tkTongDoanhThu=$data['tkTongDoanhThu'];
$tkUser=$data['tkUser'];
$tkProduct=$data['tkProduct'];
$tkHoaDon=$data['tkHoaDon'];
$tkSp=$data['tkSp'];
$usermoi=$data['usermoi'];
$hoaDonMoi=$data['hoaDonMoi'];
$allCate=$data['allCate'];
$tkDoanhThu=$data['tkDoanhThu'];
?>
<h1>Thống kê</h1>
<!-- Analyses -->
<div class="analyse">
...
<div class="new-users">
    ...
    <div class="user-list">
        <?php foreach ($usermoi as $taikhoanmoi) : ?>
            <div class="user">
                <img src="<?= BASE_URL ?>public/upload/avatar/<?= $taikhoanmoi['HinhAnh'] ?>">
